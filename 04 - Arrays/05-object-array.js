...
console.log(interation.map((value) => value * 2)) // Pega cada valor do array e multiplica por 2

console.log(interation.filter((Value) => Value % 2 !== 0)) // Percorre o array em busca dos números que a divisão inteira por 2 seja diferente de 0. Quando encontra, retorna todos os valores achados

console.log(interation.reduce((addition, value) => addition + value, 0)) // Percorre o array a partir da posição zero, e faz uma soma simples entre todos os números. Soma-se o número de índice 0, mais índice 1, mais índice 2 e assim por diante

console.log(interation.every((value) => value % 2 == 0)) // Percorre o array em busca do seguinte: vai ser analisado absolutamente todos os números da lista; se todos os números obdecerem a condição imposta, o resultado no console será true. Caso não, false. Onde está a condição? Dentro dos parênteses de "every()"
